...
echo IP:
tasklist | find /i "ngrok/ngrok.exe" >Nul && ./ngrok/ngrok tcp 3389 --host-header=localhost:4040 | findstr "tcp://" || echo "Failed to retrieve NGROK authtoken - check your authtoken again"
